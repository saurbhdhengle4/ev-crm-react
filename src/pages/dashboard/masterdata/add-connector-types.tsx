...
interface AddConnectorTypeComponentProps {
    setActiveTab: any;
}


const AddConnectorType: React.FC<AddConnectorTypeComponentProps> = ({ setActiveTab }) => {
    ...
    return (
        <div>
            <div className={styles.form}>
                ...
                />
                <label htmlFor="name" className={styles.formLabel}>Description</label>
                <textarea
...
export default AddConnectorType

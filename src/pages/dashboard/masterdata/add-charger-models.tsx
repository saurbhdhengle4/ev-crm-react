...
interface AddChargerModelsComponentProps {
    setActiveTab: any;
}


const AddChargerModels: React.FC<AddChargerModelsComponentProps> = ({ setActiveTab }) => {
    ...
    return (
        <div>
            <div className={styles.form}>
                ...
                <label htmlFor="modelNumber" className={styles.formLabel}>Model Number</label>
                <input
                ...
                <label htmlFor="maxPower" className={styles.formLabel}>Max Power</label>
                <input
                    type="number"
                ...
                <label htmlFor="voltage" className={styles.formLabel}>Voltage</label>
                <input
                    type="number"
                    placeholder="Voltage"
                ...
                <label htmlFor="current" className={styles.formLabel}>Current</label>
                <input
                    type="number"
                    placeholder="Current"
                ...
                <label htmlFor="chargerType" className={styles.formLabel}>Select Charger Type</label>
                <select
                ...
                <label htmlFor="chargerOem" className={styles.formLabel}>Select Charger OEM</label>
                <select
...
export default AddChargerModels
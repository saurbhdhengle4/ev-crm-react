...
interface ActiveRfidManagementComponentProps {
    setActiveTab: any;
}


const ActiveRfidManagement: React.FC<ActiveRfidManagementComponentProps> = ({ setActiveTab }) =>  {
...
export default  ActiveRfidManagement
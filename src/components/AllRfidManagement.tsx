...
interface AllRfidManagementComponentProps {
    setActiveTab: any;
}


const AllRfidManagement: React.FC<AllRfidManagementComponentProps> = ({ setActiveTab }) =>  {
...
export default  AllRfidManagement
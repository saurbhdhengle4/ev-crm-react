...
interface OngoingChargingSessionComponentProps {
    setActiveTab: any;
}


const OngoingChargingSession: React.FC<OngoingChargingSessionComponentProps> = ({ setActiveTab }) => {
...
export default OngoingChargingSession
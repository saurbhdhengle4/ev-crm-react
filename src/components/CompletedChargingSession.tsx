...
interface CompletedChargingSessionComponentProps {
    setActiveTab: any;
}


const CompletedChargingSession: React.FC<CompletedChargingSessionComponentProps> = ({ setActiveTab }) => {
...
export default CompletedChargingSession